...
public class Indonesia2FinalTestActivity extends AppCompatActivity {
    ...
    private final String[] soalList = {
            "Soal 1: Ibu pergi ke pasar saat pagi. Siapakah yang ke pasar ?",
            "Soal 2: Kata Kerja terdapat pada kalimat ?",
            "Soal 3: Mana Kalimat yang benar ?"
    };

    private final String[][] pilihan = {
            {"A. Ayah", "B. Saya", "C. Ibu"},
            {"A. Rina kucing suka", "B. Adik makan roti ", "C. Buku meja tas"},
            {"A. Kami belajar di kelas", "B. Kami di belajar kelas", "C. Di Kami belajar kelas"}
    };

    private final String[] jawabanBenar = {"C", "B", "A"};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_indonesia2_final_test);
        ...
        btnKembali.setOnClickListener(v -> {
            startActivity(new Intent(this, IndonesiaKelas2Activity.class));
            finish();
        });
    }

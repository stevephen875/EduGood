...
public class MatematikaKelas2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_matematika_kelas2);
        ...
        btnFinalTest.setOnClickListener(v -> {
            Intent intent = new Intent(this, Matematika2FinalTestActivity.class);
            startActivity(intent);
        });
    }
}

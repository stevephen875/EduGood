...
public class MatematikaKelas3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_matematika_kelas3);
        ...
        btnMateri1.setOnClickListener(v -> {
            Intent intent = new Intent(this, Matematika3Materi1Activity.class);
            startActivity(intent);
        });

        btnMateri2.setOnClickListener(v -> {
            Intent intent = new Intent(this, Matematika3Materi2Activity.class);
            startActivity(intent);
        });

        btnMateri3.setOnClickListener(v -> {
            Intent intent = new Intent(this, Matematika3Materi3Activity.class);
            startActivity(intent);
        });

        btnFinalTest.setOnClickListener(v -> {
            Intent intent = new Intent(this, Matematika3FinalTesActivity.class);
            startActivity(intent);
        });
    }
}
...
public class Mandarin3Quiz3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mandarin3_quiz3);
        ...
        btnBack.setOnClickListener(v -> {
            Intent intent = new Intent(this, MandarinKelas3Activity.class);

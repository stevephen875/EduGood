...
public class Mandarin2Quiz1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mandarin2_quiz1);
        ...
        btnBack.setOnClickListener(v -> {
            Intent intent = new Intent(this, MandarinKelas2Activity.class);

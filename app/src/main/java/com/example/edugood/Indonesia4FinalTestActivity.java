...
public class Indonesia4FinalTestActivity extends AppCompatActivity {
    ...
    private final String[] soalList = {
            "Soal 1: Sinonim dari kata “pandai” adalah...",
            "Soal 2: Kalimat berikut ini yang termasuk kalimat efektif adalah...",
            "Soal 3: Paragraf yang menceritakan kejadian disebut... "
    };

    private final String[][] pilihan = {
            {"A. Malas.", "B. Bodoh.", "C. Cerdas. "},
            {"A. Saya pergi ke sekolah dan saya juga ingin ke perpustakaan dan bertemu teman.", "B.  Saya ke sekolah dan juga ke perpustakaan. ", "C.  Saya pergi ke sekolah untuk belajar."},
            {"A.  Narasi", "B. Deskripsi", "C. Eksposisi"},
    };

    private final String[] jawabanBenar = {"C", "C", "A"};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_indonesia4_final_test);
        ...
        btnKembali.setOnClickListener(v -> {
            startActivity(new Intent(this, IndonesiaKelas4Activity.class));
            finish();
        });
    }

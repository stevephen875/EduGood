...
public class Indonesia3Quiz1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_indonesia3_quiz1);
    ...
    private void cekJawaban(String jawaban) {
        ...
        if ("A".equals(jawaban)) {
            hasil = "Benar! 🎉 Jawabannya adalah kalimat Tanya";

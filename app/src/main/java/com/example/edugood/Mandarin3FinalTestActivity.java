...
public class Mandarin3FinalTestActivity extends AppCompatActivity {
    ...
    private final String[] jawabanBenar = {"A", "C", "B"};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mandarin3_finaltest);

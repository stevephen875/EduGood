...
public class Indonesia4Quiz1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_indonesia4_quiz1);
    ...
    private void cekJawaban(String jawaban) {
        ...
        if ("C".equals(jawaban)) {
            hasil = "Benar! 🎉 Jawabannya adalah Pandai – Cerdas";

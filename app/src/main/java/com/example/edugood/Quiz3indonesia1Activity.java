...
public class Quiz3indonesia1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz3indonesia1);
        ...
        btnBack.setOnClickListener(v -> {
            Intent intent = new Intent(this, IndonesiaKelas1Activity.class);
    ...
    private void cekJawaban(String jawaban) {
        ...
        if ("A".equals(jawaban)) {
            hasil = "Benar! 🎉 Jawabannya Ayah pergi kerja";

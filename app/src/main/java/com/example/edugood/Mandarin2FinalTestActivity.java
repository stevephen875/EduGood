...
public class Mandarin2FinalTestActivity extends AppCompatActivity {
    ...
    private final String[] jawabanBenar = {"B", "A", "C"};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mandarin2_finaltest);
        ...
        btnKembali.setOnClickListener(v -> {
            startActivity(new Intent(this, MandarinKelas2Activity.class));
            finish();
        });
    }

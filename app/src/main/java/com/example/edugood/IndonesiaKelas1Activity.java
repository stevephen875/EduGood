...
public class IndonesiaKelas1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_indonesia_kelas1);
        ...
        btnMateri2.setOnClickListener(v -> {
            Intent intent = new Intent(IndonesiaKelas1Activity.this, Indonesia1Materi2Activity.class);
            startActivity(intent);
        });

        btnMateri3.setOnClickListener(v -> {
            Intent intent = new Intent(IndonesiaKelas1Activity.this, Indonesia1Materi3Activity.class);
            startActivity(intent);
        });

        btnFinalTest.setOnClickListener(v -> {
            Intent intent = new Intent(IndonesiaKelas1Activity.this, Indonesia1FinalTestActivity.class);
            startActivity(intent);
        });
    }
}

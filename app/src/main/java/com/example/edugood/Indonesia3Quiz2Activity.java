...
public class Indonesia3Quiz2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_indonesia3_quiz2);
        ...
        btnBack.setOnClickListener(v -> {
            Intent intent = new Intent(this, IndonesiaKelas3Activity.class);
    ...
    private void cekJawaban(String jawaban) {
        ...
        if ("C".equals(jawaban)) {
            hasil = "Benar! 🎉 Jawabannya Kupu Kupu adalah serangga bersaayap indah";
